...
// wje_tinyriscv soc顶层模块
module wje_tinyriscv_soc_top(
    ...
    //inout wire[1:0] wje_gpio,    // GPIO引脚
...
//    assign s2_data_i = `ZeroWord;
    ...
    always @ (posedge clk) begin
        if (rst == `RstEnable) begin
            ...
            over <= ~u_tinyriscv.u_regs.wje_regs[26];  // when = 1, run over
            succ <= ~u_tinyriscv.u_regs.wje_regs[27];  // when = 1, run succ, otherwise fail
        end
    end

    // wje_tinyriscv处理器核模块例化
    wje_tinyriscv u_tinyriscv(
        .clk(clk),
        .rst(rst),
...
//    // io0
//    assign wje_gpio[0] = (gpio_ctrl[1:0] == 2'b01)? gpio_data[0]: 1'bz;
//    assign io_in[0] = wje_gpio[0];
//    // io1
//    assign wje_gpio[1] = (gpio_ctrl[3:2] == 2'b01)? gpio_data[1]: 1'bz;
//    assign io_in[1] = wje_gpio[1];
//
//    // wje_gpio模块例化
//    wje_gpio gpio_0(
//        .clk(clk),
