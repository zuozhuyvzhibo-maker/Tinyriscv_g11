...
// FPGA-side wje_bridge. It receives byte-wide commands from the chip-side
// wje_bridge and accesses external ROM/RAM located in the FPGA fabric.
module wje_bridge_fpga(

    input wire clk,
    input wire rst,

    // FPGA and chip-side wje_bridge fixed 8-bit synchronous protocol
