...
module i2c #(
    ...
    assign i2c_scl = (scl_drive_low == 1'b1) ? 1'b0 : 1'bz;
    assign i2c_sda = (sda_drive_low == 1'b1) ? 1'b0 : 1'bz;
    assign scl_in = i2c_scl;
    assign sda_in = i2c_sda;
    assign temp_busy_o = busy;

    wire reg_write_en = (req_i == `RIB_REQ) && (we_i == `WriteEnable);
    ...
    wire start_temp_transfer = (temp_start_i == 1'b1) && (busy == 1'b0);
